...
class SimularCostoKzt:
    ...
    def __init__(self,
                 total_zonas=10,
                 total_meses=24,
                 costo_fijo=757.14,  # Valor fijo en CLP/m²
        ...
        # Asignar factor de dificultad fijo: mitad fácil (1.0), mitad difícil (1.3)
        n_easy = total_zonas // 2
        n_hard = total_zonas - n_easy
        factors = [1.0] * n_easy + [1.3] * n_hard
    ...
    def generar(self, guardar_csv=False, ruta_csv=None):
        ...
        for z in self.Z:
            ...
            for t in self.T:
                ...
                kzt = self.costo_fijo * factor_z * factor_infl
