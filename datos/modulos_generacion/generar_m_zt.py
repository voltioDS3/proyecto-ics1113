...
class SimularMantenimientoMzt:
    """
    Simula m_zt: costo de mantención por m² en la zona z y mes t (CLP).
    """
    def __init__(self,
                 total_zonas=10,
                 total_meses=24,
                 costo_range_m2=(1500, 3000),  # CLP por m²
                 inflation_rate=0.005):
        self.Z = list(range(1, total_zonas + 1))
        self.T = list(range(1, total_meses + 1))
        self.costo_range = costo_range_m2
